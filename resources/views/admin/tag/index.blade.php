              ...
              <div id="multi-select_wrapper" class="dataTables_wrapper">
                ...
                <thead>
                  <tr role="row"><th class="sorting_disabled" rowspan="1" colspan="1" style="width: 69px;">
                    ...
                    <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 121px;">Tag
                    </th>
                ...
                <tr role="row" class="odd">
                    ...
                    <td></td>
                    <td><button data-id="{{$tag->id}}" id="dltCategory" class=" btn waves-effect waves-light red lightrn-1">Delete</button>|<a  href="{{route('admin.tag.edit',$tag->id)}}" id="editCategory" class="btn waves-effect waves-light green lightrn-1">Edit</a></td>
                    <td>2011/04/25</td>
                    <td>$320,800</td>
                  </tr> 
                  @endforeach                 
                ...
                <tfoot>
                  <tr><th rowspan="1" colspan="1"></th><th rowspan="1" colspan="1">Tag</th><th rowspan="1" colspan="1">Action</th><th rowspan="1" colspan="1">Age</th><th rowspan="1" colspan="1">Start date</th><th rowspan="1" colspan="1">Salary</th></tr>
                </tfoot>
              </table>
